...
app.get('/dashboard', isAuthenticated, async (req, res) => {
    try {
        ...
        // Pass email, username, and cars to the template
        res.render('dashboard', { email: user.email, username: user.username, cars });
    } catch (error) {
...
app.get('/editCar/:id', isAuthenticated, async (req, res) => {
    ...
    try {
        ...
        res.render('editCar', { car, name: req.session.name, email: req.session.email });
    } catch (error) {
